...
class BatteryControl: 
    ...
    @classmethod
    def find_power_and_SOC(cls, s, h, min_SOC, max_SOC, import_tariff, export_tariff, readings_per_hour):
        ...
        # if there is a flat import / export tariff pair, employ a simple self-use battery control mechanism
